https://reactdev.ru/learn/your-first-component/
...
React Router - Марштрутизация или reacr Router DOM https://reactrouter.com/6.28.0/upgrading/v6-data (установить эту библиотеку npm i react-router-dom) 

SPA- менять контент без перзагрузки страницы
